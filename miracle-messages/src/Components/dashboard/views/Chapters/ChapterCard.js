...
class ChapterCard extends React.Component {
  ...
  getChapter = id => {
    axios
      .get(`https://miracle-messages-staging2.herokuapp.com/api/chapter/${id}`)
      .then(res => {
  ...
  getAllPartners = () => {
    axios
      .get(`https://miracle-messages-staging2.herokuapp.com/api/partner`)
      .then(res => {
        const data = res.data;
        let sponsors = [];
        let partners = [];
  ...
  getChapterPartners = id => {
    axios
      .get(
        `https://miracle-messages-staging2.herokuapp.com/api/chapter/${id}/partners`
      )
      .then(res => {
        const data = res.data;
        let sponsors = [];
  ...
  unassignPartner = id => {
    ...
    axios
      .delete(
        `https://miracle-messages-staging2.herokuapp.com/api/chapter/${chapterid}/partners/${id}`
      )
      .then(res => {
        this.getAllPartners();
  ...
  assignPartner = id => {
    ...
    axios
      .post(
        `https://miracle-messages-staging2.herokuapp.com/api/chapter/${chapterid}/partners`,
        partnerId
      )
      .then(res => {
        this.getAllPartners();
